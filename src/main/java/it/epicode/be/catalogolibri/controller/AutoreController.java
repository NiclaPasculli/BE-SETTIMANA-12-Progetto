...
public class AutoreController {
	...
	@Operation(description = "visualizza lista di autori")
	...
	@Operation(description = "creazione di un nuovo autore")
	...
	@Operation(description = "visualizza autore dell'id indicato")
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
	...
	@Operation(description = "modifica di un autore")
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	...
	@Operation(description = "cancellazione di un autore")
	@PreAuthorize("hasRole('ROLE_ADMIN')")
