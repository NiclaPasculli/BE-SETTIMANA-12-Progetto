...
public class CategoriaController {
	...
	@Operation(description = "visualizza lista di categorie")
	...
	@Operation(description = "creazione di una nuova categoria")
	...
	@Operation(description = "visualizza categoria dell'id indicato")
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
	...
	@Operation(description = "modifica di una categoria")
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	...
	@Operation(description = "cancellazione di una categoria")
	@PreAuthorize("hasRole('ROLE_ADMIN')")
